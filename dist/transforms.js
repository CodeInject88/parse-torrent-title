...
export function toWithSuffix(suffix) {
    return (title, m) => {
        if (typeof m.value === 'string') {
...
export function toValueSetWithTransform(toV) {
    return (title, m) => {
        if (m.value instanceof ValueSet) {
...
export function toValueSetMultiWithTransform(toV) {
    return (title, m) => {
        if (m.value instanceof ValueSet) {
...
export function toIntRangeTill() {
    return (title, m) => {
        if (typeof m.value !== 'string') {
            m.value = null;
            return;
